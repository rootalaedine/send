...
class GportalUi():
    ...
    def send_email_via_api(self, payload: EmailPayload, options: EmailOptions):
    ...
    def Gmail_Composer(self):
        ...
        payload = EmailPayload(subject=subject, email_list=email_list, body=body, options=options)
